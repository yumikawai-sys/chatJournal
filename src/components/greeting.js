...
export const positiveRes = [
    "Sounds wonderful! Share more details!",
    "That's fantastic! Anything else?",
    "Sounds wonderful! What else made your day great?",
    "Amazing! Tell me more about the highlights.",
    "Brilliant! What other positive moments can you share?",
    "Awesome! I'm all ears for more positivity.",
    "Incredible! Anything else worth mentioning?",
];

export const neutralRes = [
...
export const negativeRes = [
    "I hear you. Oh, that's rough...",
